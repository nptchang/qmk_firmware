...
#define _BASEGAME       2
#define _NUM            3
#define _LT_SPC_WIN     4
#define _LT_SPC_MAC     5
#define _FUNC           6
#define _ESC_WIN        7
#define _ESC_MAC        8
#define _MOUSE_WIN      9
#define _MOUSE_MAC      10
#define _TABS_WIN       11
#define _TABS_MAC       12
#define _SYS            13
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASEWIN] = LAYOUT_arrow_command(
        ...
        KC_LCTL, MO(_FUNC),  /*TD(LGUI)*/GUI_T(KC_BSPC), TD(LALT), LT(_LT_SPC_WIN,KC_SPC), MO(_NUM), MO(_MOUSE_WIN), KC_WH_D, KC_WH_U, TG(_FUNC)
        ),

	[_BASEMAC] = LAYOUT_arrow_command(
        LT(_SYS,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
        LT(_ESC_MAC, KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
        MO(_FUNC), TD(LCTL_MAC), /*TD(OPT)*/ALT_T(KC_BSPC), TD(CMD), LT(_LT_SPC_MAC,KC_SPC), MO(_NUM), MO(_MOUSE_MAC), KC_WH_U, KC_WH_D, TG(_FUNC)
        ),

	[_BASEGAME] = LAYOUT_arrow_command(
        LT(_SYS,KC_TAB), KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
        KC_ESC, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_ENT,
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
        MO(_FUNC), TD(LCTL_MAC), /*TD(OPT)*/ALT_T(KC_BSPC), TD(CMD), KC_SPC, MO(_NUM), MO(_MOUSE_MAC), KC_WH_U, KC_WH_D, TG(_FUNC)
        ),

	[_NUM] = LAYOUT_arrow_command( 
    ...
    [_LT_SPC_WIN] = LAYOUT_arrow_command(
    ...
    [_LT_SPC_MAC] = LAYOUT_arrow_command(
	...
	[_FUNC] = LAYOUT_arrow_command( 
        ...
        _______, _______, _______, _______,    _______,    _______,         KC_P0, _______, KC_PDOT, _______
        ),

	[_ESC_WIN] = LAYOUT_arrow_command( 
        ...
        _______, _______, KC_LGUI, MO(_TABS_WIN), HYPR(KC_ENT), _______, _______, _______, _______, _______
        ), 

	[_ESC_MAC] = LAYOUT_arrow_command( 
        ...
        _______, _______, _______, MO(_TABS_MAC), HYPR(KC_ENT), _______, _______, _______, _______, _______
        ),

    [_MOUSE_WIN] = LAYOUT_arrow_command(
        _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, _______, KC_BTN1, KC_BTN2, _______, _______, _______, 
        _______, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, 
        _______, _______, _______, _______, _______, _______, _______, KC_WH_D, KC_WH_U, _______, _______, _______, 
        _______, _______, _______, _______, _______, KC_ACL0, _______, _______, _______, _______ 
        ),

    [_MOUSE_MAC] = LAYOUT_arrow_command(
        _______, KC_ACL0, KC_ACL1, KC_ACL2, _______, _______, _______, KC_BTN1, KC_BTN2, _______, _______, _______, 
        _______, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______, 
        _______, _______, _______, _______, _______, _______, _______, KC_WH_U, KC_WH_D, _______, _______, _______, 
        _______, _______, _______, _______, _______, KC_ACL0, _______, _______, _______, _______ 
    ...
    [_TABS_WIN] = LAYOUT_arrow_command( 
    ...
    [_TABS_MAC] = LAYOUT_arrow_command(
	...
	[_SYS] = LAYOUT_arrow_command(
        ...
        _______, DF(_BASEGAME), DF(_BASEWIN), DF(_BASEMAC), _______, _______, _______, _______, _______, _______
        )
};
